...
# SFRP-Seatbelt
SFRP-Seatbelt is a seatbelt notification script that utilizes either QB-Core, or ox_lib to show notifications.
...
Config.Notify = 'Set_ME'  ---------- options for now are qb and ox


---------------------------------- Made By StarFallTeam  (Kayden)
```
seatbelt.lua
```
Config = Config or {}
